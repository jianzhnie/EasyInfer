#!/bin/bash
# =============================================================================
# Kimi-K2.7-Code W4A8 — API functional test script
# =============================================================================
# Targets localhost:8013 by default.
#
# Usage:
#   ./curl_test.sh
...
HOST="${HOST:-localhost}"
PORT="${PORT:-8013}"
MODEL_NAME="${MODEL_NAME:-kimi-k2.7-code}"
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  Kimi-K2.7-Code W4A8 API 功能测试"
echo "  目标地址: ${BASE_URL}"
...
# 4. Code generation (code-tuned model)
run_test "代码生成" \
    "${BASE_URL}/v1/chat/completions" \
    '{"model":"'"$MODEL_NAME"'","messages":[{"role":"user","content":"Write a Python function to check if a number is prime."}],"max_tokens":256,"temperature":0.2}'
...
echo ""
echo "=========================================="
log_success "Kimi-K2.7-Code W4A8 所有测试完成!"
echo "=========================================="
