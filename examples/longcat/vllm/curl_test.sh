#!/bin/bash
# =============================================================================
# LongCat-Flash-Chat-1024E-512Zero-Topk24-v2 — API functional test script
# =============================================================================
...
#   MODEL_NAME=longcat-flash-chat ./curl_test.sh
# =============================================================================
set -euo pipefail
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  LongCat-Flash-Chat API 功能测试"
echo "  目标地址: ${BASE_URL}"
...
echo ""
echo "=========================================="
log_success "LongCat-Flash-Chat 所有测试完成!"
echo "=========================================="
