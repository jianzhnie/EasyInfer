#!/bin/bash
# =============================================================================
# LongCat-Flash-Chat-depth32 — API functional test script
# =============================================================================
# Targets localhost:8020 by default.
#
# Usage:
#   ./curl_test_depth32.sh
#   HOST=10.0.0.1 PORT=8020 ./curl_test_depth32.sh
#   MODEL_NAME=longcat-flash-depth32 ./curl_test_depth32.sh
# =============================================================================
set -euo pipefail
...
HOST="${HOST:-localhost}"
PORT="${PORT:-8020}"
MODEL_NAME="${MODEL_NAME:-longcat-flash-depth32}"
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  LongCat-Flash-Chat-depth32 API 功能测试"
echo "  目标地址: ${BASE_URL}"
...
echo ""
echo "=========================================="
log_success "LongCat-Flash-Chat-depth32 所有测试完成!"
echo "=========================================="
