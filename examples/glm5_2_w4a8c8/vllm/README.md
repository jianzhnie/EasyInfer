...
bash examples/glm5_2_w4a8c8/vllm/run_vllm.sh

# A2 两节点 (TP=8 PP=2, 更大上下文)
RAY_ADDRESS=<head>:6379 PP=2 bash examples/glm5_2_w4a8c8/vllm/run_vllm.sh

# 后台运行
nohup bash examples/glm5_2_w4a8c8/vllm/run_vllm.sh > glm5_2_w4a8c8_vllm.log 2>&1 &

# 打开 MTP 投机解码（仅 PP=1 可用，PP>1 与 MTP 互斥）
ENABLE_MTP=1 bash examples/glm5_2_w4a8c8/vllm/run_vllm.sh
```
...
```bash
# 运行测试脚本
bash examples/glm5_2_w4a8c8/vllm/curl_test.sh
