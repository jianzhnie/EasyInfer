#!/bin/bash
# =============================================================================
# Step-3.7-Flash W8A8 MTP — API functional test script
# =============================================================================
# Targets localhost:8015 by default.
#
# Usage:
#   ./curl_test.sh
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  Step-3.7-Flash W8A8 MTP API 功能测试"
echo "  目标地址: ${BASE_URL}"
...
echo ""
echo "=========================================="
log_success "Step-3.7-Flash W8A8 MTP 所有测试完成!"
echo "=========================================="
