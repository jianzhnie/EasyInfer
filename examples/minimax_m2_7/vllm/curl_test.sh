#!/bin/bash
# MiniMax-M2.7 W8A8 QuaRot — API 功能测试脚本
# 默认使用 localhost:8004
# 256 Experts MoE, W8A8 量化
# 注意: MTP 在 vLLM-Ascend 0.20.2 暂不支持 MiniMax 架构
#
# 用法:
#   ./curl_test.sh                               # 默认测试 localhost:8004
...
# ================ 主程序 ================
echo "=========================================="
echo "  MiniMax-M2.7 W8A8 QuaRot API 功能测试"
...
echo ""
echo "=========================================="
log_success "MiniMax-M2.7 W8A8 QuaRot 所有测试完成!"
echo "=========================================="
