...
bash examples/kimi-k2.5_w4a8/vllm/run_vllm.sh

# TP=8 DP=2 (高吞吐)
DP=2 TP=8 bash examples/kimi-k2.5_w4a8/vllm/run_vllm.sh

# 长上下文 128K
TP=16 DP=1 MAX_MODEL_LEN=131072 bash examples/kimi-k2.5_w4a8/vllm/run_vllm.sh

# 多节点 DP (A2 × 2)
TP=4 DP=4 RAY_ADDRESS=<head>:6379 bash examples/kimi-k2.5_w4a8/vllm/run_vllm.sh
```

### 验证

```bash
bash examples/kimi-k2.5_w4a8/vllm/curl_test.sh
