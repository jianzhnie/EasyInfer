...
#
# Constraints:
#   - GLM-5 does not support PP; PD disaggregation only supports TP scaling
...
echo "[WARN] GLM-5 does not support PP; PD disaggregation uses TP across nodes"
echo "============================================"
