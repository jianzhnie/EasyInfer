#!/bin/bash
# =============================================================================
# GLM-5 W4A8 — PD Colocated with Mooncake (multi-instance)
# =============================================================================
...
#
#   # Multi-instance (one instance per node)
#   # Node1: MOONCAKE_CONFIG_PATH=/path/to/mooncake.json bash run_pd_colocated.sh
#   # Node2: MOONCAKE_CONFIG_PATH=/path/to/mooncake.json PORT=8101 bash run_pd_colocated.sh
#
# Reference:
