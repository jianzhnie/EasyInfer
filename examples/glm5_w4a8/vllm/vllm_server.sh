#!/bin/bash
# =============================================================================
# GLM-5 W4A8 部署示例 (华为 NPU 环境)
# =============================================================================
# 调用 vllm_model_server.sh 部署 GLM-5 W4A8 量化模型
# GLM-5 采用 MoE 架构 (256 专家 + 1 共享)，支持 MTP 投机解码
#
# 硬件要求:
...
#
# 用法:
#   # 默认 W4A8 (A2 8 卡, 32k 上下文)
#   ./vllm_server.sh
#
#   # A3 16 卡 (200k 上下文)
#   TENSOR_PARALLEL_SIZE=16 MAX_MODEL_LEN=200000 MAX_NUM_SEQS=8 ./vllm_server.sh
#
#   # 多节点 8×8 卡
...
# 启动信息
# ------------------------------------------------------------------------------
echo "[INFO] Starting GLM-5 W4A8 server"
