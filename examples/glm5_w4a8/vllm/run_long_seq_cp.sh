...
echo "============================================"
echo "[INFO] GLM-5 W4A8 — Long Sequence Context Parallel"
...
echo "[WARN] GLM-5 W4A8: FLASHCOMM1=0 (DSA CP compatibility)"
echo "============================================"
