#!/bin/bash
# GLM-5 W4A8 — 长序列上下文并行 (Context Parallelism)
# 功能: 通过 Context Parallelism 突破单卡序列长度限制
# 注意: GLM-5 W4A8 的 DSA CP 路径不兼容，需要 A3 设备
...
#   - 当前仅支持 Atlas A3 设备
#   - GLM-5 W4A8: VLLM_ASCEND_ENABLE_FLASHCOMM1=0 (DSA CP 路径不兼容)
#
# 用法:
#   # A3 单节点 (TP=16, DCP=2)
...
echo "[WARN] GLM-5 W4A8: FLASHCOMM1=0 (DSA CP 路径兼容性)"
echo "============================================"
