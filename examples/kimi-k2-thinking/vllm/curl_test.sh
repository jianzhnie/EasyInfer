#!/bin/bash
# =============================================================================
# Kimi-K2-Thinking W4A8 — API functional test script
# =============================================================================
# Targets localhost:8003 by default.
# Thinking model: responses may include reasoning_content.
#
# Usage:
#   ./curl_test.sh
...
HOST="${HOST:-localhost}"
PORT="${PORT:-8003}"
MODEL_NAME="${MODEL_NAME:-kimi-k2-thinking}"
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  Kimi-K2-Thinking W4A8 API 功能测试"
echo "  目标地址: ${BASE_URL}"
...
# 4. Thinking/Reasoning test
run_test "Thinking/Reasoning (数学推理)" \
    "${BASE_URL}/v1/chat/completions" \
    '{"model":"'"$MODEL_NAME"'","messages":[{"role":"user","content":"What is 123 * 456? Show your reasoning step by step."}],"max_tokens":256,"temperature":0.7}'
...
echo ""
echo "=========================================="
log_success "Kimi-K2-Thinking W4A8 所有测试完成!"
echo "=========================================="
