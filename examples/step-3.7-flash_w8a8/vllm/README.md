...
```bash
# 单节点 TP=8 + MTP（默认）
bash examples/step-3.7-flash_w8a8/vllm/run_vllm.sh

# 关闭 MTP
ENABLE_MTP=0 bash examples/step-3.7-flash_w8a8/vllm/run_vllm.sh

# 大上下文
MAX_MODEL_LEN=131072 bash examples/step-3.7-flash_w8a8/vllm/run_vllm.sh

# 后台运行
nohup bash examples/step-3.7-flash_w8a8/vllm/run_vllm.sh > step37_vllm.log 2>&1 &
```

### 验证

```bash
bash examples/step-3.7-flash_w8a8/vllm/curl_test.sh
