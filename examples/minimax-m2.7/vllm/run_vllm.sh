#!/bin/bash
# =============================================================================
# MiniMax-M2.7 FP8 — vllm serve deployment
# =============================================================================
# Architecture: MiniMaxM2ForCausalLM | 256 Experts | MoE | FP8
#
# Hardware:
...
#   TP=4 DP=4 bash run_vllm.sh                        # TP=4 DP=4 single-node A3
#   TP=8 DP=2 bash run_vllm.sh                        # TP=8 DP=2 high-throughput
#
# Reference:
...
echo "============================================"
echo "[INFO] MiniMax-M2.7 FP8 — vLLM-Ascend Deployment"
