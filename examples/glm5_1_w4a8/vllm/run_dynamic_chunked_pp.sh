#!/bin/bash
# =============================================================================
# GLM-5.1 W4A8 — Dynamic Chunked Pipeline Parallel
# =============================================================================
# Status: Not applicable — GLM-5.1 architecture does not support Pipeline
...
[REASON] GLM-5.1 architecture does not support Pipeline Parallelism
[ALT] Use large TP across nodes:
      TP=16 PP=1 MAX_MODEL_LEN=202752 bash run_vllm.sh
============================================

GLM-5.1 uses the GlmMoeDsaForCausalLM architecture, which lacks the SupportsPP
