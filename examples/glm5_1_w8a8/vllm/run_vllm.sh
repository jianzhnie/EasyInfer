...
#   <project>/.cache/glm5.1-w8a8 (shared NFS/home mount) → temp files, runtime logs, home
#   /root/.cache/... (overlay, exec) → triton/torchinductor (need .so loading)
# =============================================================================
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
ROOT_DIR="$(cd "$SCRIPT_DIR/../../../.." && pwd)"
readonly CACHE_ROOT="${CACHE_ROOT:-$ROOT_DIR/.cache/glm5.1-w8a8}"
readonly EXEC_CACHE_ROOT="${EXEC_CACHE_ROOT:-/root/.cache/glm51-w8a8-cache}"
