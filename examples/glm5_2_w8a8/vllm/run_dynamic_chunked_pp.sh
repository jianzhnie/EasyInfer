#!/bin/bash
# =============================================================================
# GLM-5.2 W8A8 — Dynamic Chunked Pipeline Parallel
# =============================================================================
# Status: Not applicable — GLM-5.2 architecture does not support Pipeline
#         Parallelism (GlmMoeDsaForCausalLM lacks the SupportsPP interface).
#
# Alternative: Use large TP across nodes.
#   TP=16 PP=1 MAX_MODEL_LEN=131072 bash run_vllm.sh
#
# Reference:
...
[REASON] GLM-5.2 architecture does not support Pipeline Parallelism
[ALT] Use large TP across nodes:
      TP=16 PP=1 MAX_MODEL_LEN=131072 bash run_vllm.sh
============================================

GLM-5.2 uses the GlmMoeDsaForCausalLM architecture, which lacks the SupportsPP
