...
```bash
# 单节点 (32K 上下文, TP=8)
bash examples/glm-5.1_w4a8/vllm/run_vllm.sh

# 2 节点大 TP (202K 上下文)
TP=16 MAX_MODEL_LEN=202752 bash examples/glm-5.1_w4a8/vllm/run_vllm.sh

# 后台运行
nohup bash examples/glm-5.1_w4a8/vllm/run_vllm.sh > glm5_1_vllm.log 2>&1 &

# 使用传统包装器部署
bash examples/glm-5.1_w4a8/vllm/vllm_server.sh
```
...
```bash
# 运行测试脚本
bash examples/glm-5.1_w4a8/vllm/curl_test.sh
...
| 时间 | 镜像 | 节点 | 配置 | 结果 | 日志 |
|------|------|------|------|------|------|
| 2026-07-20 | `quay.io/ascend/vllm-ascend:v0.22.1rc1-a3` (CANN 8.5.1) | pair2: 10.42.11.198/199 | TP=16 PP=1, PORT=8002 | ✅ PASS | `logs/parallel_deploy_v022_rerun/glm5.1-w4a8_*.log` |
| 2026-07-21 | 同上 | pair4: 10.42.11.202/203 | TP=16 PP=1, PORT=8002 | ✅ PASS (复测) | `logs/glm51_w4a8_reverify_vllm.log` |
