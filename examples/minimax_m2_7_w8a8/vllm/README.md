...
bash examples/minimax_m2_7_w8a8/vllm/run_vllm.sh

# A2 单节点 (TP=8)
TP=8 DP=1 bash examples/minimax_m2_7_w8a8/vllm/run_vllm.sh

# 高吞吐 (TP=8 DP=2)
TP=8 DP=2 bash examples/minimax_m2_7_w8a8/vllm/run_vllm.sh

# 长上下文 128K (DSA CP)
TP=8 DECODE_CP=2 MAX_MODEL_LEN=138000 bash examples/minimax_m2_7_w8a8/vllm/run_vllm.sh
```

### 验证

```bash
bash examples/minimax_m2_7_w8a8/vllm/curl_test.sh
