#!/bin/bash
# =============================================================================
# Kimi-K2.5 W4A8 — Traditional wrapper deployment (Multimodal)
# =============================================================================
# Calls scripts/vllm/vllm_model_server.sh to deploy Kimi-K2.5 W4A8.
# Architecture: KimiK25ForConditionalGeneration, 384-expert MoE, Vision support.
# Text backbone: DeepseekV3ForCausalLM; supports Pipeline Parallelism.
#
# Hardware:
...
# ------------------------------------------------------------------------------
export MODEL_PATH="${MODEL_PATH:-/home/jianzhnie/llmtuner/hfhub/models/moonshotai/Kimi-K2.5}"
export SERVED_MODEL_NAME="${SERVED_MODEL_NAME:-kimi-k2.5}"
...
# ------------------------------------------------------------------------------
# Parallel configuration (Kimi-K2.5 MoE, 384 experts, DeepSeek V3 text backbone)
# ------------------------------------------------------------------------------
...
# Kimi-K2.5 has no MTP (same as K2.6).
...
# Startup banner
# ------------------------------------------------------------------------------
echo "[INFO] Starting Kimi-K2.5 W4A8 server"
...
echo "[INFO] Features:  MoE (384 experts), Vision (multimodal)"
