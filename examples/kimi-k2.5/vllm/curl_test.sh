#!/bin/bash
# =============================================================================
# Kimi-K2.5 W4A8 — API functional test script (Multimodal)
# =============================================================================
# Targets localhost:8005 by default.
...
# ------------------------------------------------------------------------------
echo "=========================================="
echo "  Kimi-K2.5 W4A8 API 功能测试 (多模态)"
echo "  目标地址: ${BASE_URL}"
...
echo ""
echo "=========================================="
log_success "Kimi-K2.5 W4A8 所有测试完成!"
echo "=========================================="
